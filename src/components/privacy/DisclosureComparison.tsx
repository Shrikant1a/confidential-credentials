...
export const DisclosureComparison: React.FC = () => {
  return (
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 sm:gap-6 relative">
        {/* Left: Traditional Verification */}
        <Card
          variant="elevated"
          className="p-5 sm:p-7 border-rose-900/40 bg-gradient-to-b from-rose-950/20 via-midnight-900 to-midnight-950 relative overflow-hidden"
        >
          <div className="flex items-center justify-between border-b border-rose-900/30 pb-3.5 mb-4">
            ...
            <span className="text-[10px] sm:text-[11px] font-mono text-rose-400 font-semibold px-2 py-0.5 rounded bg-rose-500/10 border border-rose-500/20 whitespace-nowrap">
              100% Exposed
            </span>
          </div>
          ...
          <div className="space-y-2 font-mono text-xs">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between p-2.5 rounded-lg bg-midnight-950 border border-rose-900/30 gap-1">
              <span className="text-slate-400">Exact CGPA & Marks:</span>
        ...
        <Card
          variant="elevated"
          className="p-5 sm:p-7 border-brand-purple/40 bg-gradient-to-b from-purple-950/20 via-midnight-900 to-midnight-950 relative overflow-hidden"
        >
          <div className="flex items-center justify-between border-b border-brand-purple/30 pb-3.5 mb-4">
            <div className="flex items-center gap-2.5">
            ...
            <span className="text-[10px] sm:text-[11px] font-mono text-brand-purple font-semibold px-2 py-0.5 rounded bg-brand-purple/10 border border-brand-purple/20 whitespace-nowrap">
          ...
          <div className="space-y-2 text-xs">
            <div className="flex items-center justify-between p-2.5 rounded-lg bg-emerald-950/30 border border-emerald-500/30 text-emerald-300 gap-2">
            ...
            <div className="p-3 rounded-lg bg-midnight-950 border border-brand-purple/20 space-y-1.5 font-mono text-[11px]">
              <div className="flex items-center justify-between text-slate-400">
                <span className="flex items-center gap-1.5">
                  <Lock className="w-3.5 h-3.5 text-brand-purple shrink-0" />
                  Full Name & ID:
                </span>
