...
import { truncateAddress, formatDate } from '../../src/utils/formatters';
...
export const IssuerPage: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 space-y-8">
      ...
      <Card variant="elevated" className="p-6 border-slate-800 space-y-4 bg-gradient-to-r from-midnight-900 via-midnight-900 to-blue-950/20">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-2xl bg-midnight-850 border border-slate-700 flex items-center justify-center text-3xl">
              {activeIssuer.logo}
            </div>
            <div>
              <div className="flex items-center gap-2">
                <h3 className="text-lg font-bold text-slate-100">{activeIssuer.name}</h3>
          ...
          <div className="flex items-center gap-4 text-xs font-mono">
            <div className="p-2.5 rounded-xl bg-midnight-950 border border-slate-800 text-center">
              <span className="text-slate-500 block text-[10px]">TOTAL ISSUED</span>
